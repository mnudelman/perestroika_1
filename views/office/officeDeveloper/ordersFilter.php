...
<div id="<?= $htmlPrefix ?>-filter"
    ...
    $form = ActiveForm::begin([
        'id' => 'developer-orders-filter-form',
        'action' => '#',
    ...
    <?=$form->field($filterForm, 'responseStat')
        ->checkbox() ; ?>
        </div>

    <!--    <div class="checkbox" style="margin-left: 5px">-->
<!--        <label >-->
<!--            <input type="checkbox" checked="checked" id="orderFilterForm-checkbox" name="orderFilterForm[checkBox]" >-->
<!--                 Только заказы, требующие ответа-->
<!--        </label>-->
<!--    </div> <br>-->

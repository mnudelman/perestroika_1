...
<!-- правая часть  -изменения -->
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary" id="<?=$htmlPrefix?>-panel">
                <div class="panel-heading">
                ...
                <div class="panel-body">
                    ...
                    <div id="<?=$htmlPrefix?>-area" hidden="hidden">
                        <!--                    <ul class="list-group" >-->
                        ...
                        <a class="btn btn-default" role="button" title="region fully in work geography"
                           id="<?=$htmlPrefix?>-fully-bt" onclick="setItemStat('<?=$htmlPrefix?>-fully')"
                           data-toggle="tooltip" data-placement="left" >
                            <span class="glyphicon glyphicon-share"></span>
                        </a>
                        <button class="btn btn-default" role="button" title="region removed from work gegraphy"
                           id="<?=$htmlPrefix?>-delete-bt" onclick="setItemStat('<?=$htmlPrefix?>-delete')"
                           data-toggle="tooltip" data-placement="top">
                            <span class="glyphicon glyphicon-minus"></span>
                        </button>

                        <ul class="list-group collapse.in" id="<?=$htmlPrefix?>-editSetItem-ul"
